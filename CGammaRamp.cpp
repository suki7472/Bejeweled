...
BOOL CGammaRamp::LoadLibrary()
{
    ...
    hGDI32 = ::LoadLibrary(WStr);
    if (hGDI32 != NULL)
    {
        //Get the addresses of GetDeviceGammaRamp and SetDeviceGammaRamp API functions.
        FARPROC procAddr = GetProcAddress(hGDI32, "GetDeviceGammaRamp");
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wcast-function-type"
        pGetDeviceGammaRamp = reinterpret_cast<Type_SetDeviceGammaRamp>(procAddr);
#pragma GCC diagnostic pop

        procAddr = GetProcAddress(hGDI32, "SetDeviceGammaRamp");
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wcast-function-type"
        pSetDeviceGammaRamp = reinterpret_cast<Type_SetDeviceGammaRamp>(procAddr);
#pragma GCC diagnostic pop
